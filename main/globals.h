...
extern uint8_t DB_DISABLE_WIFI_ARMED;   // 0 = WiFi remains enabled always, 1 = WiFi will be turned off when armed state is detected on the telemetry stream. Does not work when DB_SERIAL_PROTOCOL is set to transparent
